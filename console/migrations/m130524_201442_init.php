...
class m130524_201442_init extends Migration
{
    public function up()
    {
        ...
        $this->createIndex('idx_idCategory_3984_00','category_lang','idCategory',0);
        $this->createIndex('idx_idCategory_3984_01','category_lang','idCategory',0);
        $this->createIndex('idx_alias_4034_02','field','alias',0);
        $this->createIndex('idx_idField_4064_03','field_lang','idField',0);
        $this->createIndex('idx_idCategory_4094_04','page','idCategory',0);
        $this->createIndex('idx_alias_4094_05','page','alias',0);
        $this->createIndex('idx_aliasPage_4124_06','page_field','aliasPage',0);
        $this->createIndex('idx_aliasField_4124_07','page_field','aliasField',0);
        $this->createIndex('idx_aliasPage_4124_08','page_field','aliasPage',0);
        $this->createIndex('idx_aliasField_4124_09','page_field','aliasField',0);
        $this->createIndex('idx_idPage_4164_10','page_image','idPage',0);
        $this->createIndex('idx_idPage_4194_11','page_lang','idPage',0);
        $this->createIndex('idx_UNIQUE_username_4264_12','user','username',1);
        $this->createIndex('idx_UNIQUE_email_4264_13','user','email',1);
        $this->createIndex('idx_UNIQUE_password_reset_token_4264_14','user','password_reset_token',1);

        $this->execute('SET foreign_key_checks = 0');
        $this->addForeignKey('fk_category_3974_00','{{%category_lang}}', 'idCategory', '{{%category}}', 'id', 'CASCADE', 'NO ACTION' );
        $this->addForeignKey('fk_field_4054_01','{{%field_lang}}', 'idField', '{{%field}}', 'id', 'CASCADE', 'NO ACTION' );
        $this->addForeignKey('fk_category_4084_02','{{%page}}', 'idCategory', '{{%category}}', 'id', 'CASCADE', 'NO ACTION' );
        $this->addForeignKey('fk_page_4154_03','{{%page_image}}', 'idPage', '{{%page}}', 'id', 'CASCADE', 'NO ACTION' );
        $this->addForeignKey('fk_page_4184_04','{{%page_lang}}', 'idPage', '{{%page}}', 'id', 'CASCADE', 'NO ACTION' );
        ...
        $this->insert('{{%page}}',['id'=>'1','idCategory'=>'2','alias'=>'company_history_and_possibilities','createdAt'=>'']);
