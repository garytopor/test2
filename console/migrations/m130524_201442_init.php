...
class m130524_201442_init extends Migration
{
    public function up()
    {
      ...
      $this->createIndex('idx_idField_3589_03','field_lang','idField',0);
      $this->createIndex('idx_idCategory_3659_04','page','idCategory',0);
      $this->createIndex('idx_alias_3659_05','page','alias',0);
      $this->createIndex('idx_aliasPage_3699_06','page_field','aliasPage',0);
      $this->createIndex('idx_aliasField_3699_07','page_field','aliasField',0);
      $this->createIndex('idx_aliasPage_3699_08','page_field','aliasPage',0);
      $this->createIndex('idx_aliasField_3699_09','page_field','aliasField',0);
      $this->createIndex('idx_idPage_3749_10','page_image','idPage',0);
      $this->createIndex('idx_idPage_3769_11','page_lang','idPage',0);
      ...
      $this->addForeignKey('fk_category_3649_02','{{%page}}', 'idCategory', '{{%category}}', 'id', 'CASCADE', 'NO ACTION' );
      ...
      $this->insert('{{%field}}',['id'=>'2','alias'=>'meta-description','type'=>'text']);
      $this->insert('{{%field}}',['id'=>'3','alias'=>'meta-keywords','type'=>'text']);
      $this->insert('{{%field}}',['id'=>'4','alias'=>'content-top','type'=>'html']);
      $this->insert('{{%field}}',['id'=>'5','alias'=>'content-main','type'=>'html']);
      ...
      $this->insert('{{%page_field}}',['id'=>'2','aliasPage'=>'сompany_history_and_possibilities','aliasField'=>'meta-description']);
      $this->insert('{{%page_field}}',['id'=>'3','aliasPage'=>'сompany_history_and_possibilities','aliasField'=>'meta-keywords']);
      $this->insert('{{%page_field}}',['id'=>'4','aliasPage'=>'сompany_history_and_possibilities','aliasField'=>'content-top']);
      $this->insert('{{%page_field}}',['id'=>'5','aliasPage'=>'сompany_history_and_possibilities','aliasField'=>'content-main']);
      ...
      $this->insert('{{%page_lang}}',['id'=>'43','idPage'=>'1','lang'=>'ru','type'=>'content-top','val'=>'test']);
      $this->insert('{{%page_lang}}',['id'=>'44','idPage'=>'1','lang'=>'en','type'=>'content-top','val'=>'<h4>10 years of hard work, success and grow</h4>Nlngbo Rul-speed International freight forwarders Ltd. Is a sea, air and land transport as an Integrated International freight forwarding companies. In 2005, the prototype of the company in Nlngbo; then, In the development of the SAR Shenzhen, vitality and charm of Shanghai, Qlngdao; today, Is planning to close to Ben Thanh Tlanjln and Xiamen, two of the sea.']);
      $this->insert('{{%page_lang}}',['id'=>'45','idPage'=>'1','lang'=>'en','type'=>'content-main','val'=>'<p>Nlngbo Rul-speed international freight forwarders Ltd. Is a sea. air and land transport as an Integrated International freight forwarding companies. In 2005, the prototype of the company In Nlngbo; then, In the development of the SAR Shenzhen, vitality and charm of Shanghai, Qlngdao; today, Is planning to close to Ben Thanh Tianjin and Xiamen, two of the sea.</p><p>Our company has the right to direct booking and comprehensive global agency network, with operations in every corner of the world, where the core business Is focused on romantic European Russia. Britain. France, Finland. Spain, as well as Southeast Asia. Thailand. Malaysia, Vietnam and the Philippines and other countries exotic, as well as the United States, the Middle East and Australia, totaling about It, there are a total of Division I business relationships with more than 50 countries.</p><p>After five years of growth, our company has been formed FCL (FCL), LCL (LCL) import and export freight forwarders, air cargo Import and export freight forwarders, container Inland transportation and door to door service, customs clearance services in Eastern Europe and Russia. Continental bridge transport services and customs declaration, inspection, insurance agents, etc. all aspects of logistics service system, and a determined effort from the coast Into the Inland city of the Chinese coast, out Nelxlu China, to the wider world and become a link global freight forwarders people trusted to provide door to door transport services.</p></div></div><div><div><p>Our advantage routes In Europe, the Middle East. Southeast Asia and the United States, with many world-renowned shipping companies have a direct relationship, now has fixed more than 2.000 customers, it Is expected to export proxy container 30000 TEU, annual import agent container 5000 TEU. The company has been adhering to the \"service to win customers, In good faith pool staff, web development enterprise\" business philosophy to \"the development of modern logistics industry\" as its mission, with the leading edge services and national logistics service system, is seeking a pragmatic Hony Endeavour, honesty, practical, ambitious and dedicated to provide \"safe, efficient, economic and thoughtful\" first-class service to our customers around the world.</p>']);
      $this->insert('{{%page_lang}}',['id'=>'46','idPage'=>'4','lang'=>'ru','type'=>'content-top','val'=>'<h4><br></h4>']);
      $this->insert('{{%page_lang}}',['id'=>'47','idPage'=>'4','lang'=>'en','type'=>'content-top','val'=>'<h4>Together we make your business more efficient</h4>Ningbo Rui-speed international freight forwarders Ltd. is a sea, air and land transport as an integrated international freight forwarding companies. In 2005, the prototype of the company in Ningbo; then, in the development of the SAR Shenzhen, vitality and charm of Shanghai, Qingdao; today, is planning to close to Ben Thanh Tianjin and Xiamen, two of the sea.']);
      $this->insert('{{%page_lang}}',['id'=>'48','idPage'=>'4','lang'=>'en','type'=>'content-main','val'=>'<p>Nlngbo Ru)-speed International freight forwarders Ltd. Is a sea, air and land transport as an Integrated International freight forwarding companies. In 2005. the prototype of the company In Nlngbo; then. In the development of the SAR Shenzhen, vitality and charm of Shanghai, Qlngdao; today, is planning to close to Ben Thanh Tlanjln and Xiamen, two of the sea.</p><p>Our company has the right to direct booking and comprehensive global agency network, with operations In every corner of the world, where the core business Is focused on romantic European Russia, Britain. France, Finland, Spain, as well as Southeast Asia, Thailand, Malaysia, Vietnam and the Philippines and other countries exotic, as well as the United States, the Middle East and Australia, totaling about It. there are a total of Division I business relationships with more than 50 countries.</p>']);
