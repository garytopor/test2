...
<div class="col-md-2">
    <div class="panel panel-white">
        ...
        <h6 class="panel-title"><span class="text-semibold"><?php echo $model->getContentByTypeLang('fio', 'i18n')->val; ?></span></h6>
        ...
        <div class="panel-body">
            <?php echo $model->getField('post')->field->content->val; ?> :
            <?php echo $model->getContent('post')->val; ?> <br/>
