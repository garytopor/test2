...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 06 2016 г., 05:10
...
(116, 1, 'img-top', 'source', 'company_history_and_possibilities-img-top-57f5466d479dc', 'jpg', 0, 0, 1210, 338),
(117, 1, 'img-top', 'desktop', 'company_history_and_possibilities-img-top--desktop-57f5466d7f875', 'jpg', NULL, NULL, NULL, NULL),
(118, 1, 'img-top', 'mobile', 'company_history_and_possibilities-img-top--mobile-57f5466e0bf5c', 'jpg', NULL, NULL, NULL, NULL);
...
(309, 19, 'i18n', 'fio', 'Имя человека'),
(310, 19, 'en', 'post', 'export and import director'),
(311, 19, 'i18n', 'tel', '574-87259554'),
...
(317, 20, 'ru', 'post', 'экспорт и импорт директор'),
